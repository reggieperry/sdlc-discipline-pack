...
> Elder examples in this guide are illustrative — they show what Liskov's
> level-ownership discipline looks like applied to a non-trivial codebase.
> The principle applies across projects.
